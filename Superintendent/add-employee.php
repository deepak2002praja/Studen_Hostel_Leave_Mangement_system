        ...
        <div class="sidebar-menu">
            ...
            <div class="main-menu">
                <div class="menu-inner">
                    <?php
                        $page='employee';
                        include '../includes\Superitendent-sidebar.php';
                    ?>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">SUPERITENDENT <i class="fa fa-angle-down"></i></h4>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Hostel No.</label>
                                            <input class="form-control" name="country" type="text"    required id="example-text-input">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Bed No.</label>
