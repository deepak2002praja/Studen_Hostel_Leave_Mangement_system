...
<body>
    ...
    <div class="login-area login-s2">
        ...
        <div class="container">
    <h1>JUET Student Leave Management System</h1>
                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">login as Warden</a></p>
                            <p class="text-muted"><a href="Superintendent/index.php">login as Superintendent</a></p>
